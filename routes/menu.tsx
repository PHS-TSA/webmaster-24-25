    ...
    <main class="py-4">
      ...
      <div class="flex flex-col items-center gap-4 p-4">
        <MenuItem
          price="$9.99"
          name="Fruit Salad"
          description="Kiwis, bananas, grapefruit, strawberries, pineapple, blueberries, and raspberries. Oh my! Served with a wonderful coconut pudding"
          side="left"
        >
          <MenuImage image="what-we-serve_r9qi3z" description="Yum!" />
        </MenuItem>
        ...
        <MenuItem
          ...
          description="If only goldilocks tried this porridge first. It would have been just right with its blend of millet, quinoa, cinnamon, and fresh fruit!"
          side="right"
        >
          <MenuImage image="what-we-serve_r9qi3z" description="Yum!" />
        </MenuItem>
        ...
        <MenuItem
          ...
          description="Banana, mango, kiwi, pineapple, and spinach blended together and topped with raspberries and chia seeds"
          side="left"
        >
          <MenuImage image="what-we-serve_r9qi3z" description="Yum!" />
        </MenuItem>
      ...
      <div class="flex flex-col items-center gap-4 p-4">
        <MenuItem
          price="$3.99"
          name="Ginger Tea"
          description="Fragrant and warming ginger tea with a hint of lemon"
          side="left"
        >
          <MenuImage image="what-we-serve_r9qi3z" description="Yum!" />
        </MenuItem>
